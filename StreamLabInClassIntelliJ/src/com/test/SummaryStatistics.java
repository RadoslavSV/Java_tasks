...
public class SummaryStatistics {
    ...
    public double companyStatsWithStreamAverage() {
        ...
        // TASK TO DO
        OptionalDouble avgRevenue = companies.stream().mapToDouble(x -> x.getRevenue()).average();
        System.out.printf("COMPANY AVERAGE WITH STREAM: %.2f\n", avgRevenue.getAsDouble());
        // ENDS HERE

        return avgRevenue.getAsDouble(); // return the average
    }
